        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                @if ($message = Session::get('fail'))
                    <div id="alert" class="alert alert-danger" style="background-color: rgb(241, 167, 171)">
                        {{ $message }}
                        <button id="close-btn" type="button"
                            class="border-none btn btn-sm float-right my-auto pt-0">x</button>
                    </div>
                ...
                {{-- Delete Modal --}}
                <!-- Modal -->
                <div class="modal fade" id="deletemodalpop" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger deletebtn"
                                        data-action="{{ '/destroy' . '/' . $data->id }}">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
